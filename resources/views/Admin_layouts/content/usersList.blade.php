			...
			<table class="ui selectable celled table datatable">
			  ...
			  <tbody>
			    ...
			    <tr>
					...
					<td class="selectable">
			        	<a href={{URL('/edituser/'.$user->id)}}><i class="edit sign icon orange large"></i></a>
			      	</td>
			      	<td class="selectable">
			      		<a href={{URL('/viewuser/'.$user->id)}}><i class="address book icon orange large"></i></a>
			      	</td>
			    </tr>
				@endforeach
			  </tbody>
...
@section('scripts')
    <script src="{{ URL::asset('/js/listusers.js') }}"></script>
@endsection
