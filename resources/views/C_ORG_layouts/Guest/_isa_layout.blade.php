    ...
    <div class="ui" id="ISA">
        <div class="ui secondary vertical pointing menu" id="ISA_menu">
          ...
          <div class="ui dropdown item">
            ...
            <div class="menu">
              <a class="item" id="showProjPhasesMan">@lang('strings.projPhasesMan')</a>
              <a class="item" id="showProjParticipant">@lang('strings.projParticipant')</a>
              <a class="item" id="showDefineDocAcce">@lang('strings.defineDocAcce')</a>
            </div>
          </div>
