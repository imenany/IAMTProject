                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('fonction') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="fonction" type="select" class="form-control" name="fonction" value="{{ old('fonction') }}" required autofocus>
                                    <option value="C_ORG">C_ORG</option>
                                    <option value="AI_ORG">AI_ORG</option>
                                </select>
